...
login-back
<body class="signin" style="background:url(/Public/img/admin/login-background.jpg)">
    ...
    <div class="row">
        ...
        <div class="col-sm-5">
            <form id="fromSubmit" method="post" onsubmit="" action="<?php echo U('Public/do_login');?>">
                ...
                <input type="text" name="account" maxlength="22" class="form-control uname" placeholder="用户名" style="background:#fff url(/Public/img/admin/user.png) no-repeat 95% center;"/>
                <input type="password" name="password" maxlength="32" class="form-control pword m-b" style="background:#fff url(/Public/img/admin/locked.png) no-repeat 95% center;" placeholder="密码" />
